...
- (id) init
{
	...
	{
      ProjektArray=[[[NSMutableArray alloc] initWithCapacity: 0]autorelease];
      neueProjekteArray=[[[NSMutableArray alloc] initWithCapacity: 0]autorelease];
      [neueProjekteArray retain];
	  
	}
	neuesProjektDic=[[NSMutableDictionary alloc]init];
	[neuesProjektDic retain];
  ...
  if ([ProjektTable selectedRow]>=0)
  {
	  ...
	  switch (antwort)
	  {
		  ...
		  case NSAlertThirdButtonReturn://ex		
		  {
			  ...
			  [ProjektEntfernenString release];
