...
- (IBAction)showKommentar:(id)sender
{
	...
	[ProjektPfadOptionString retain];
	...
	NSMutableDictionary* KommentarStringDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
...
- (NSArray*)createKommentarStringArrayWithProjektPfadArray:(NSArray*)derProjektPfadArray
{
	...
	[tempProjektPfadArray retain];
	//[derProjektPfadArray release];
	...
	NSArray* TabellenkopfArray=[[NSArray arrayWithObjects:name,titel,datum,bewertung,note,anmerkungen,nil]retain];
//	NSArray* TabellenkopfArray=[[NSArray arrayWithObjects:name,titel,datum,note,anmerkungen,nil]retain];
				...
				if ([tempKommentarArray count])
				{
					switch (AbsatzOption)
					{
						case alsTabelleFormatOption:
						{
							...
							{
								NSMutableDictionary* returnDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
							...
							for (index=0;index<[tempKommentarArray count];index++)
							{
								...
								//Kommentar als Array von Zeilen
								NSMutableArray* tempKomponentenArray=(NSMutableArray*)[[tempKommentarString componentsSeparatedByString:crSeparator]retain];
								int zeile;
...
//
					...
					NSMutableDictionary* tempKommentarStringDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
...
//**********	
	...
	NSMutableArray* returnKommentarStringArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	...
	while (einKommentarDic =[KommentarEnum nextObject])
	{
		...
		if (tempAlleKommentareString && [tempAlleKommentareString length])
		{
			...
			NSMutableArray* neuerKommentarArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	...
	if ([returnKommentarStringArray count]==0)
	{
		...
		NSMutableDictionary* keinKommentarStringDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
...
{
	NSMutableArray* tempProjektDicArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	...
	switch (DruckAuswahlOption)
	{
		case 0://Nur ein Projekt
		{
			...
			NSMutableDictionary* tempProjektDictionary=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
						  ...
						  maximal:(int)dieAnzahl
{
	...
	BOOL istDirectory;
	NSString* locKommentar=NSLocalizedString(@"Comments",@"Anmerkungen");
	NSMutableArray* alleKommentareArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
...
- (NSArray*)alleKommentareNachTitelAnProjektPfad:(NSString*)derProjektPfad bisAnzahl:(int)dieAnzahl
{
	...
	[alleKommentareNachTitelArray retain];
	...
	if ([Filemanager fileExistsAtPath:LeserPfad])//Ordner des Lesers ist da
	  {
		NSLog(@"Leser %@ da",derLeser);
		  NSMutableArray* tempAufnahmen=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
		  tempAufnahmen=(NSMutableArray*)[Filemanager contentsOfDirectoryAtPath:LeserPfad error:NULL];
		...
		if ([Filemanager fileExistsAtPath:LeserKommentarPfad isDirectory:&istDirectory]&&istDirectory)//Ordner des Lesers ist da)
		  {
			 ...
			 NSMutableArray*  tempTitelArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
					...
					//NSLog(@"Kommentar zu File %@ kann nicht aufgenommen werden",tempTitel);
					  ...
					  if (pos)
						{//Ab zweitem Kommentar Name entfernen
						  NSMutableArray* tempZeilenArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
...
- (NSArray*)lastKommentarVonAllenAnProjektPfad:(NSString*)derProjektPfad
{
	...
	NSFileManager *Filemanager=[NSFileManager defaultManager];
	NSMutableArray* tempKommentarArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	NSMutableArray* LeserArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	NSString* tempProjektPfad=[AdminArchivPfad stringByAppendingPathComponent:[derProjektPfad lastPathComponent]];
				  ...
				  while (tempKommentar=[enumerator nextObject])
					...
					NSString* tempKommentarString=[NSString stringWithContentsOfFile:tempKommentarPfad encoding:NSMacOSRomanStringEncoding error:NULL];
					  ...
					  if ([tempDatum isEqualTo:[heute description]])
						  ...
						  [heutigerKommentarString retain];
						  }
...
- (NSArray*)TitelArrayVon:(NSString*)derLeser anProjektPfad:(NSString*)derProjektPfad
{
	...
	if ([Filemanager fileExistsAtPath:LeserPfad])//Ordner des Lesers ist da
	  {
		  NSMutableArray* tempAufnahmenArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
						  ...
						  bisAnzahlProLeser:(int)dieAnzahl
{
	...
	*/
	...
	NSMutableArray* tempTitelArrayVonAllen= [[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	NSString* tempProjektPfad=[AdminArchivPfad stringByAppendingPathComponent:[derProjektPfad lastPathComponent]];
	if ([Filemanager fileExistsAtPath:tempProjektPfad isDirectory:&istDirectory]&&istDirectory)
	{
	...
	while (einLeser=[LeserEnumerator nextObject])
	  {
		...
		NSArray* tempTitelArray=[[self TitelMitKommentarArrayVon:einLeser anProjektPfad:tempProjektPfad]retain];
...
- (NSArray*)LeserArrayVonTitel:(NSString*)derTitel
{
	...
	NSMutableArray* tempLeserArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	NSString* locKommentar=NSLocalizedString(@"Comments",@"Anmerkungen");
						...
						if ([Filemanager fileExistsAtPath:lastKommentarPfad])//Kommentar für letzte Aufnahme ist da)
						  {
							  ...
							  [lastKommentarMitTitelString retain];
...
- (NSArray*)TitelMitAnzahlArrayVon:(NSString*)derLeser
{
	...
	NSMutableArray* tempTitelArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	NSMutableArray* tempTitelDicArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
	NSString* locKommentar=NSLocalizedString(@"Comments",@"Anmerkungen");
	NSString* LeserPfad=[AdminProjektPfad stringByAppendingPathComponent:derLeser];
	[LeserPfad retain];
	//NSString* LeserKommentarPfad=[LeserPfad stringByAppendingPathComponent:kommentar];//Kommentarordner des Lesers
				...
				if ([tempAufnahmenArray count])
				  {
					...
					id eineAufnahme;
					int anz=1;
					NSString* lastTitel=[[NSString string]retain];
					while (eineAufnahme=[enumerator nextObject])
					  {
						//NSLog(@"tempAufnahmenArray eineAufnahme: %@",eineAufnahme);
						NSString* tempAufnahmePfad=[LeserPfad stringByAppendingPathComponent:eineAufnahme];
...
- (NSArray*)sortNachNummer:(NSArray*)derArray
{
	...
	tempArray =[[derArray mutableCopy]retain];
	//return derArray;
	//[derArray release];
...
- (NSString*)alleKommentareVonHeute
{
	...
	NSString* lastKommentarString=@"";//Anmerkungen in Tabelle mit 6 Kolonnen konvertieren \r";
		...
		while (tempLeser = [enumerator nextObject]) 
		  {
			lastKommentarString=[lastKommentarString stringByAppendingString:[self lastKommentarVonLeser:tempLeser]];
