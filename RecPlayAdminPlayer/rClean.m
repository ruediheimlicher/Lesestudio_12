...
extern NSString* AIFF;//=@"AIFF";
extern NSString* AIFC;//=@"AIFC";
extern NSString* WAVE;//=@"WAVE";
extern NSString* AVI;//=@"AVI";
extern NSString* uLAW;//=@"uLAW";
extern NSString* MP3;//=@"mp3";
extern NSString* MOV;//=@"mp3";
extern NSString* AudioCDTrack;//=@"AudioCDTrack";
...
- (IBAction)reportNurTitelZuNamenOption:(id)sender
{
	...
	[nurTitelZuNamenOptionNumber retain];
	if (nurTitelZuNamenOption)
	{
...
- (IBAction)reportExport:(id)sender
{
	...
	if ([tempNamenArrray count])
	{
		if ([tempTitelArray count])
		{
			NSMutableDictionary* FormatauswahlDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
