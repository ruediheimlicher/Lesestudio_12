		...
		switch([ViewTagNumber intValue])
		  {
			case NamenViewTag:
			{
				...
				NSMutableArray* CleanTitelDicArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
				...
				NSMutableArray* neueTitelArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease]; //Kontrollarray nur mit Titeln
				//NSLog(@"CleanTitelDicArray von: %@: \n%@\n",tempName, [CleanTitelDicArray description]);
				NSMutableArray* TitelMitAnzahlArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
						...
						{//
							...
							case 1://alle bis auf anzahlBehalten löschen
							{
								...
								while(einLeserTitel=[LeserTitelEnum nextObject])
								  {
									NSEnumerator* AufnahmenEnum=[tempAufnahmenArray objectEnumerator];
									NSMutableArray* tempDeleteTitelArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
									[tempDeleteTitelArray retain];
									id eineAufnahme;
									while(eineAufnahme=[AufnahmenEnum nextObject])
									  {
