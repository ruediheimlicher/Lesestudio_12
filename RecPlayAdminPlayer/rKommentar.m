...
if ([derKommentarString length]==0)
	...
	NSTextTab* TitelTab1=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:90]autorelease];
	...
	NSMutableParagraphStyle* ProjektStil=[[[NSMutableParagraphStyle alloc]init]autorelease];
	[ProjektStil setTabStops:[NSArray array]];//default weg
	NSTextTab* ProjektTab1=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:150]autorelease];
	...
	
	{
		case alsTabelleFormatOption:
		{
			...
			NSTextTab* TabellenkopfTitelTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:titeltab]autorelease];
			[TabellenKopfStil addTabStop:TabellenkopfTitelTab];
			NSTextTab* TabellenkopfDatumTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:datumtab]autorelease];
			...
			NSTextTab* TabellenkopfNoteTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:notetab]autorelease];
			[TabellenKopfStil addTabStop:TabellenkopfNoteTab];
			NSTextTab* TabellenkopfAnmerkungenTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:anmerkungentab]autorelease];
			...
			NSTextTab* TabelleTitelTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:titeltab]autorelease];
			[TabelleStil addTabStop:TabelleTitelTab];
			NSTextTab* TabelleDatumTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:datumtab]autorelease];
			...
			NSTextTab* TabelleNoteTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:notetab]autorelease];
			[TabelleStil addTabStop:TabelleNoteTab];
			NSTextTab* TabelleAnmerkungenTab=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:anmerkungentab]autorelease];
			...
			[[KommentarView textStorage]appendAttributedString:attrKopfString];
				...
				//Stil für Abstand2
	NSMutableParagraphStyle* Abstand2Stil=[[[NSMutableParagraphStyle alloc]init]autorelease];
	...
	[[KommentarView textStorage]appendAttributedString:attrAbstand2String];
		...
		case alsAbsatzFormatOption:
		{
			...
			NSMutableParagraphStyle* AbsatzStil=[[[NSMutableParagraphStyle alloc]init]autorelease];
...
- (void)setKommentarMitKommentarDicArray:(NSArray*)derKommentarDicArray
{
	...
	NSTextTab* TitelTab1=[[[NSTextTab alloc]initWithType:NSLeftTabStopType location:90]autorelease];
		...
		//Stil für Abstand12
	NSMutableParagraphStyle* Abstand12Stil=[[[NSMutableParagraphStyle alloc]init]autorelease];
...
{
	NSMutableDictionary* KommentarOptionDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
